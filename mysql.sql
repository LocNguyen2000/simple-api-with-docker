...
CREATE TABLE
    `users` (
        ...
        KEY `customerNumber` (`customerNumber`),
        CONSTRAINT `users_ibfk_1` FOREIGN KEY (`employeeNumber`) REFERENCES `employees` (`employeeNumber`),
        CONSTRAINT `users_ibfk_2` FOREIGN KEY (`customerNumber`) REFERENCES `customers` (`customerNumber`)
...
VALUES (
        1,
        'newcus',
        '$2b$10$6dxndmySfGVgzumWo7H49OyaNVYkaZIuVcFrNg2nBErmH0Knm0mp6',
        NULL,
        103,
        NULL,
        NULL,
        ...
        2,
        'newEm',
        '$2b$10$0pF2J76kQt0y5vFalzrF1.RvFvC0U24IvmdhkUY5RDRsIu5lmtMMq',
        1002,
        NULL,
        NULL,
        NULL,
        ...
        3,
        'president',
        '$2b$10$gaXCo9X40ylXHuuHczrt1.7Wyn6PCHBCUQlBzwkQctm3W1b3ADZyK',
        2000,
        NULL,
        NULL,
        NULL,
        ...
        4,
        'manager',
        '$2b$10$Syn6jlg4GctfMO9NkuraM.XNHO7XgsOz8/CA56MQMODVE8gNojsfG',
        2001,
        NULL,
        NULL,
        NULL,
        ...
        7,
        'leader',
        '$2b$10$ZOAxHqeZ4.QEh7gWWUToquUXsobyVvi6668B7AIm6MRL11wwr5YcW',
        2002,
        NULL,
        NULL,
        NULL,
        ...
        8,
        'staff',
        '$2b$10$L3Xd.47L6GTsNKfBJL1fgejhOa0si5AZ0knlKrDy.EALBtwQdWEJW',
        2003,
        NULL,
        NULL,
        NULL,
        ...
        9,
        'customer',
        '$2b$10$HJLeY1ZjPZKG57LyuInICed6HEuJBA0N0g.SRrCgcfsk0O09hWFSW',
        NULL,
        1000,
        NULL,
        NULL,
...
-- Dump completed on 2022-10-03  0:05:52